...
public class ProductsDetails {
	...
	public String editProductForm(@PathVariable("id") Integer id, @RequestParam("p") Optional<Integer> p, Model model) {
		model.addAttribute("TitlePage", "Products Page");
		model.addAttribute("views", "/views/admin/ProductsDetails.jsp");
		...
		if (optionalProduct.isPresent()) {
			...
			return "/admin/index"; // This is the edit product form view
		} else {
	...
	public String saveProduct(@Validated @ModelAttribute("prod") Product product, BindingResult result, Model model,
