	...
	<div class="row">
		<div class="col-xs-8">
			<div class="card card-success">
				<div class="card-heading">
					<h3 style="margin-top: 15px; margin-left: 20px;">Thông Tin
						Thanh Toán</h3>
				</div>
				<div class="card-body">
					<form:form role="form" action="/cart/checkout" method="POST"
						...
						<div class="form-group m-3">
							<label for="note" class="control-label">Ghi chú đơn
								hàng(Không bắt buộc)</label>
		...
		<div class="col-xs-4" style="margin-top: 10px;">
			<div class="card card-info">
				<div class="card-heading">
					<h3 style="margin-left: 30px; margin-top: 10px;">Đơn Hàng Của
						Bạn</h3>
				</div>
				<div class="card-body">
